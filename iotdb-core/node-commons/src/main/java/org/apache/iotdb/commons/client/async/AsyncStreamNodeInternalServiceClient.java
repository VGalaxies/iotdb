...
public class AsyncStreamNodeInternalServiceClient extends IStreamNodeRPCService.AsyncClient
  ...
  private final ClientManager<TEndPoint, AsyncStreamNodeInternalServiceClient> clientManager;

  public AsyncStreamNodeInternalServiceClient(
      ThriftClientProperty property,
      TEndPoint endPoint,
      TAsyncClientManager tClientManager,
      ClientManager<TEndPoint, AsyncStreamNodeInternalServiceClient> clientManager)
      throws IOException {
    super(
  ...
  public static class Factory
      extends AsyncThriftClientFactory<TEndPoint, AsyncStreamNodeInternalServiceClient> {
    ...
    public void destroyObject(
        TEndPoint endPoint, PooledObject<AsyncStreamNodeInternalServiceClient> pooledObject) {
      pooledObject.getObject().close();
    }

    @Override
    public PooledObject<AsyncStreamNodeInternalServiceClient> makeObject(TEndPoint endPoint)
        throws Exception {
      return new DefaultPooledObject<>(
          new AsyncStreamNodeInternalServiceClient(
