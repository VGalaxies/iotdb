...
public enum Metric {
  ...
  PIPE_RESOURCE_CURRENT_REFERENCE_COUNT("pipe_resource_current_reference_count"),
  PIPE_RESOURCE_DECREASE_REFERENCE_COUNT("pipe_resource_decrease_reference_count"),
