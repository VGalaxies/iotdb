...
public class ReusableFilterAndProjectOperator extends FilterAndProjectOperator {

  @SuppressWarnings("squid:S107")
  public ReusableFilterAndProjectOperator(
  ...
  public ReusableFilterAndProjectOperator(
      ReusableFilterAndProjectOperator filterAndProjectOperator, Operator inputOperator) {
    super(filterAndProjectOperator, inputOperator);
  }

  @Override
  public void close() throws Exception {
    if (((StreamOperatorContext) operatorContext).getDriverContext().isTaskClosing()) {
      super.close();
      return;
    }
    resetForReuse();
