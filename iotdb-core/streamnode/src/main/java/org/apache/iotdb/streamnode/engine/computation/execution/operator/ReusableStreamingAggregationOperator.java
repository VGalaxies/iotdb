...
public class ReusableStreamingAggregationOperator extends StreamingAggregationOperator {

  public ReusableStreamingAggregationOperator(
      StreamingAggregationOperator streamingAggregationOperator, Operator child) {
    super(streamingAggregationOperator, child);
  }
