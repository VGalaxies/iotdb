...
public class StreamNodeTemporaryQueryDataFileServiceProvider
    implements ITemporaryQueryDataFileServiceProvider {
  @Override
  public AbstractTemporaryQueryDataFileService getService() {
    return StreamNodeTemporaryQueryDataFileService.getInstance();
  }
}
