...
package org.apache.iotdb.streamnode.exception;

import org.apache.iotdb.streamnode.engine.scheduler.task.IStreamDriver;

/** A common exception to pass to {@link IStreamDriver#failed(Throwable)}. */
public class DriverTaskAbortedException extends Exception {

  public static final String BY_SCHEDULER_ABORT_CALLED = "called";
