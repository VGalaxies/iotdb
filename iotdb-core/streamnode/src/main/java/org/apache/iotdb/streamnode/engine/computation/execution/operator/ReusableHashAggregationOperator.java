...
public class ReusableHashAggregationOperator extends HashAggregationOperator {

  public ReusableHashAggregationOperator(
      HashAggregationOperator hashAggregationOperator, Operator child) {
    super(hashAggregationOperator, child);
  }
