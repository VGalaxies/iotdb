...
public class ReusableAggregationOperator extends AggregationOperator {

  public ReusableAggregationOperator(AggregationOperator aggregationOperator, Operator child) {
    super(aggregationOperator, child);
  }
