...
streamPlaceholder
    : '$' '{'
      (PREV_VALUE | NEXT_VALUE | PREV_TIME | NEXT_TIME | START_TIME | END_TIME | ROW_NUM | INTEGER_VALUE)
      '}'
    ;
...
nonReserved
    ...
    | NANOSECOND | NESTED | NEXT | NEXT_TIME | NEXT_VALUE | NFC | NFD | NFKC | NFKD | NO | NODEID | NONE | NULLIF | NULLS
